  ...
  return (
    ...
    >
      ...
      <div className="w-[100%] p-3 lg:mr-7 lg:w-[65%]">
        ...
        {session && (
          <>
            <h1 className="mb-2 text-lg font-semibold">Patient Information</h1>
            <div>
        ...
        <>
          ...
          <div>
            ...
            <p className="w-[75%] text-body-sm">Service desc for after care</p>
          </div>
        </>

        {/* Medical Concerns */}
        <>
          <h1 className="mb-2 mt-7 text-lg font-semibold">Medical Concerns</h1>
          <div>
            ...
            <>
              <div className="px-5 py-2">
                ...
                <div className="flex justify-between">
                  <h1 className="font-semibold text-stroke-dark">Total Days</h1>
