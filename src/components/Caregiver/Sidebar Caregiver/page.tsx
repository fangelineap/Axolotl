...
const CaregiverSidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      <aside
        ref={dropdownRef}
        className={`fixed left-0 top-0 z-9999 flex h-screen w-72 flex-col overflow-y-hidden border-r border-stroke bg-white transition-transform duration-500 ease-in-out dark:border-stroke-dark dark:bg-gray-dark ${
          sidebarOpen
