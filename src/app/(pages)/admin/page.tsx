  ...
  return (
    <DefaultLayout>
      ...
      <div className="flex w-full items-center justify-center">
        <div className="flex w-[85%] flex-col items-center justify-between gap-5 p-8 xl:p-15 xl:flex-row xl:items-start xl:gap-0">
          <Image
          ...
          <div className="flex flex-col xl:gap-10 gap-4">
            <div className="text-center xl:text-right">
              <h1 className="text-heading-5 lg:text-heading-4 font-medium">Order Logs</h1>
              <div className="mt-5 flex justify-center gap-2 xl:gap-4 xl:justify-end">
                <Link href="/admin/order/service" title="Order Service">
                  <div className="h-25 w-25 lg:h-35 lg:w-35 cursor-pointer">
            ...
            <div className="text-center xl:text-right">
              <h1 className="text-heading-5 lg:text-heading-4 font-medium">Management</h1>
              <div className="mt-5 flex justify-center gap-2 xl:gap-4 xl:justify-end">
