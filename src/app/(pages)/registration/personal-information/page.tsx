...
//   const paramsSession = searchParams.get("signed-in");
//   const paramsData = searchParams.get("data");

//   if ([paramsRole, paramsUser, paramsSession, paramsData].includes(null)) {
//     router.refresh();
//   }
...
function RolePersonalInformationPage() {
  return (
    <DefaultLayout>
      <div>Cleo le Minerale</div>
    </DefaultLayout>
  );
}

export default RolePersonalInformationPage;
