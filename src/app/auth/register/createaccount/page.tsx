    ...
    <DefaultLayout>
      ...
      <div className="mb-3.5 flex items-center justify-center">
        <div className="grid min-w-[350px] grid-cols-2 gap-4 gap-x-10 lg:flex lg:gap-7">
          ...
          <div className="flex items-center justify-start gap-1">
            <h2
              className={`flex h-7 w-7 items-center justify-center rounded-full bg-kalbe-gray-secondary font-medium text-white ${searchParams.role === "Caregiver" && screen.width > 1000 && "ml-2"}`}
            >
          ...
          <form action="#">
            <div className="p-6.5">
              ...
              <div className="mt-5.5 flex justify-center gap-3">
                ...
                <Link
                  href={{
                    pathname: "/auth/register/createaccount/personalinformation",
                    query: { role: searchParams.role },
                  }}
                  className="flex w-1/4 justify-center"
                >
                  <button className="w-full rounded-[7px] bg-primary p-[8px] font-medium text-white hover:bg-opacity-90">
                    Next
                  </button>
                </Link>
              </div>
